...
* Macros
******************************************************************************/
#define enginelf_HTTP_URL_LENGTH 200
#define enginelf_HTTP_DOMAINNAME_LENGTH 150
#define enginelf_HTTP_DATABUFFER_SIZE 512
...
typedef struct HttpMainContextTag
{
    ...
    u8       Address[enginelf_HTTP_URL_LENGTH+1];
    ...
    u8   	hostip[30];
    u16      hostport;
    u8        hostname[enginelf_HTTP_DOMAINNAME_LENGTH+1];
    u8        hostipAddres[5];
