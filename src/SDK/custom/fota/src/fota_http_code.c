...
s32 enginelf_stricmp_bylength(char *firststr, char *secondstr, int length)
{
    char firstchar;
    char secondchar;
    while (length)
...
static bool DecodeHttpLine(u8 *startpos, s32 linelength, HttpLineValue_t *lineValue)
{
    ...
    //find the HTTP head
    if((enginelf_stricmp_bylength((char*)startpos, (char*)"HTTP",4) == 0) && (linelength > 4))
    {
    ...
    /*Content-Length: 77*/        
    if((linelength > 15) && (enginelf_stricmp_bylength((char*)startpos, "CONTENT-LENGTH:", 15) == 0))
    {
    ...
    if((linelength > 26) && (enginelf_stricmp_bylength((char*)startpos, "TRANSFER-ENCODING: CHUNKED", 26)== 0))
    {
    ...
    /*Date: */
    if((linelength > 26) && (enginelf_stricmp_bylength((char*)startpos, "DATE:", 5)== 0))
    {
