...
void SMS_TextMode_Send(void)
{
    ...
    char strTextMsg[] = "M203C MODULE SMS Test\0";
    char strConMsgSeg1[] = "M203C MODULE CON-SMS Test Start:<< GSM/GPRS modules are based on open standards and meet the requirements of applicable international standards and leg\0";
