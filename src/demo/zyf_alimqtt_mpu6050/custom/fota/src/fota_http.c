...
void http_initialize(void)
{
    ...
    httpContext_p->genhttp_dstconstsize = Enginelf_HTTP_DATABUFFER_SIZE;
...
s32 http_SendHttpGetHead( s32 socketId)
{
    ...
    httpContext_p->http_socketdata_p = (u8 *)Ql_MEM_Alloc(Enginelf_HTTP_DATABUFFER_SIZE);
    if(NULL == httpContext_p->http_socketdata_p)
    {
