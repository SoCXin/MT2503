...
static char HAL_BUFFER[1024];
#define HAL_Printf(FORMAT,...) {\
    Ql_memset(HAL_BUFFER, 0, 1024);\
    Ql_sprintf(HAL_BUFFER,FORMAT,##__VA_ARGS__); \
   	Ql_UART_Write(UART_PORT1, (u8*)(HAL_BUFFER), Ql_strlen((const char *)(HAL_BUFFER)));\
}
